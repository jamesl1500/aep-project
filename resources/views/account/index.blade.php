            ...
            <div class="leftNavigations col-lg-3">
                ...
                <div class="navigationBlock">
                    <div class="innerBlock">
                        <h3>Navigation</h3>
                        <ul>
                            <li class="active"><a href="{{ route('account.index') }}">Account Dashboard</a></li>
                    ...
                    <div class="accountInfo">
                        <div class="innerInfo">
                            <div class="topUserInfo">
                                <ul>
                                    <li><span>Fullname:</span> <?php echo ucwords(auth()->user()->name); ?></li>
                                    <li><span>Email:</span> <?php echo ucwords(auth()->user()->email); ?></li>
                                </ul>
                                <ul>
                                    <li><a href="{{ route('account.account_addresses') }}">View all Addresses</a></li>
                                </ul>
                            </div>
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($orders as $order)
                                                            {
                                                                ?>
                                                                    <tr>
                                                                        <td class="order_id_string"><a href="<?php echo url('/'); ?>/order/<?php echo $order->order_id; ?>"><?php echo substr($order->order_id, 0, 30); ?>...</a></td>
