    ...
    <div class="inner-header">
        <div class="top-header">
            <div class="inner-top-header container-fluid">
                <div class="row">
                    <div class="branding col col-lg-1 col-md-1 col-sm-1 col-1">
                        <h3><a href="{{ route('home.index') }}">AEP</a></h3>
                    </div>
                    <div class="nav-links col col-lg-2 d-lg-block d-md-none d-sm-none d-none col-6">
                        <ul>
                    ...
                    <div class="search-bar col col-lg-6 col-md-7 col-sm-6 col-6">
                    ...
                    <div class="nav-btns col col-lg-3 col-md-4 col-sm-5 col-5">
